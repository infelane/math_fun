...
# own libraries
folder_loc = '/home/lameeus/Documents/Link to Python/2017_04'
...
class Layers1():
    def __init__(self, x, layer_config, keep_prob):
        ...
        self.list_a.append(dropoutLayer(self.list_a[-1], (keep_prob + 1.0)/2))
        ...
        for index, layer_type in enumerate(layer_types):
            ...
            if layer_type == 'fus_conv':
                ...
                input_i = tf.concat([self.list_a[-1] , self.list_a[0][:, 2:-2, 2:-2, :]], axis = 3)
            ...
            if layer_type == 'last':
                ...
                layer = LastLayer(self.list_a[-1], W)
            ...
            if layer_type == 'conv':
                ...
                layer = ConvLayer(self.list_a[-1], W, b)
            ...
            if layer_type == 'deconv':
                ...
                shape_out = [tf.shape(self.list_a[-1])[0], self.layer_size[index + 1][0], self.layer_size[index + 1][1],
                             self.kernel_depth[index + 1]]
                
                layer = DeConvLayer(self.list_a[-1], W, shape_out)
            ...
            if layer_type == 'convrgb':
                ...
                layer = ConvLayerRGB(self.list_a[-1], W)
            ...
            if layer_type == 'convsame':
                ...
                layer = ConvSameLayer(self.list_a[-1], W, b, keep_prob)
            ...
            if layer_type == 'conv1':
                ...
                layer = ConvLayer1(self.list_a[-1], kernel_size[index],
            ...
            if layer_type == 'deconvsame':
                ...
                layer = DeConvLayer(self.list_a[-1], W, shape_out, padding = "SAME")
            ...
            if layer_type == 'softmax':
                ...
                layer = SoftmaxLayer(self.list_a[-1], kernel_size_i,
            ...
            if layer_type == 'softmaxsame':
                ...
                layer = SoftmaxLayerSame(self.list_a[-1], kernel_size_i,
                                     kernel_depth_i, layer_size_out, index)
                self.var.update(layer.vars)
    
                self.log_out = layer.get_log_out()

            self.list_a.append(layer.get_output())
    
            # dropout
            if layer_type == 'conv':
                self.list_a.append(dropoutLayer(self.list_a[-1], keep_prob))
