...
def main():
    ...
    parser.add_argument('--model', default='complex_unet',
                        help="The model type")
    parser.add_argument('--save_dir', default='/home/lameeus/data/general/weights/simple2')     # where to save
    ...
    if args.dataset == 'art':
        ...
        (x_train, y_train), (x_test, y_test) = data_sets.load_art(ext_tot=ext_tot)
    ...
    if not args.testing:
        ...
        train_net.test(model=model, data=(x_test, y_test), args=args)
